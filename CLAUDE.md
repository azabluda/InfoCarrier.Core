...
**`Total tests: 16100, Passed: 15984, Failed: 24, Skipped: 92`** (2026-08-03) across the
...
The 24, read out of `artifacts/measure/a45b.txt`: **16** of them are the three query bases A33
adopted, classified by cause in `docs/implementation-plan.md` (A33's table, less what A34
and A36–A45 closed); the other 8 are 2 query, 2 `ComplexTypesTracking`, 1 `WithConstructors`,
