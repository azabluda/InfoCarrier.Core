...
**`Total tests: 18743, Passed: 18497, Failed: 83, Skipped: 163`** (2026-08-04) across the
...
A59's, A61's and A62's own tables for the 39 those batches added**, read out of `artifacts/measure/`. Only **4** are wrong answers
...
- **The `GraphUpdates` residual** — 1 of 1787, one parameterization of
  ...
  had drifted badly.
- **The remaining spec bases** — 60 the compliance test still reports unadopted. Phase A in
