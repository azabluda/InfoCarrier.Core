...
**`Total tests: 19419, Passed: 19137, Failed: 119, Skipped: 163`** (2026-08-04) across the
...
- **The `GraphUpdates` residual** — 1 of 1787, one parameterization of
  ...
  had drifted badly.
- **The remaining spec bases** — 55 the compliance test still reports unadopted. Phase A in
