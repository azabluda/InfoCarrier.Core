...
**`Total tests: 21285, Passed: 20963, Failed: 120, Skipped: 202`** (2026-08-04) across the
...
- **The `GraphUpdates` residual** — 1 of 1787, one parameterization of
  ...
  had drifted badly.
- **The remaining spec bases** — 49 the compliance test still reports unadopted. Phase A in
