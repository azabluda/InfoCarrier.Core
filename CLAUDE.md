...
**`Total tests: 12878, Passed: 12797, Failed: 52, Skipped: 29`** (2026-08-03) across the
...
`OverzealousInitialization` are clear. The 52, read out of `artifacts/measure/m30.txt`: 22
query, 9 `LazyLoadProxy`, 8 `ManyToMany*Load`, 5 `FieldMapping`, 3 `WithConstructors`, 2
