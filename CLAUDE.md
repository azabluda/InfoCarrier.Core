...
**`Total tests: 18498, Passed: 18283, Failed: 56, Skipped: 159`** (2026-08-04) across the
...
A59's own table for the 12 it added that are still red**, read out of `artifacts/measure/`. Only **4** are wrong answers
