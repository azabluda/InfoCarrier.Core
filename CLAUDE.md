...
**`Total tests: 19547, Passed: 19253, Failed: 131, Skipped: 163`** (2026-08-04) across the
...
- **The `GraphUpdates` residual** — 1 of 1787, one parameterization of
  ...
  had drifted badly.
- **The remaining spec bases** — 52 the compliance test still reports unadopted. Phase A in
