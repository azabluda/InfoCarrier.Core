...
**`Total tests: 18621, Passed: 18380, Failed: 82, Skipped: 159`** (2026-08-04) across the
...
A59's and A61's own tables for the 38 those two batches added**, read out of `artifacts/measure/`. Only **4** are wrong answers
...
- **The `GraphUpdates` residual** — 1 of 1787, one parameterization of
  ...
  had drifted badly.
- **The remaining spec bases** — 63 the compliance test still reports unadopted. Phase A in
