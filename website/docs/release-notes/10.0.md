...
### The client contract is async only

`3.1` carried sync and async pairs, and the sync half was routinely implemented by blocking.
Synchronous `DbContext` calls still work.
