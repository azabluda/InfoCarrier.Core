...
To use gRPC, a message bus or an in-process call, write one small class. `IInfoCarrierTransport` has
one method.
...
- Compiled models
- Savepoints, and one transaction shared across two client contexts. `3.1` had begin, commit and
  rollback only
