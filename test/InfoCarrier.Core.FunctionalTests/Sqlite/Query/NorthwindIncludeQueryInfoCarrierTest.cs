    ...
    : NorthwindIncludeQueryRelationalTestBase<NorthwindQueryInfoCarrierSqliteFixture<NoopModelCustomizer>>(fixture)
{
    ...
    /// <inheritdoc />
    [StoreLimit(
        Upstream.EfCore + "test/EFCore.Sqlite.FunctionalTests/Query/NorthwindIncludeQuerySqliteTest.cs#L13-L17",
    ...
    /// <inheritdoc />
    [StoreLimit(
        Upstream.EfCore + "test/EFCore.Sqlite.FunctionalTests/Query/NorthwindIncludeQuerySqliteTest.cs#L19-L23",
        Justification = Upstream.GaveNoReason)]
    ...
    /// <inheritdoc />
    [StoreLimit(
        Upstream.EfCore + "test/EFCore.Sqlite.FunctionalTests/Query/NorthwindIncludeQuerySqliteTest.cs#L30-L34",
        Justification = Upstream.GaveNoReason)]
    ...
    /// <inheritdoc />
    [StoreLimit(
        Upstream.EfCore + "test/EFCore.Sqlite.FunctionalTests/Query/NorthwindIncludeQuerySqliteTest.cs#L25-L28",
        Justification = Upstream.GaveNoReason)]
