...
/// </remarks>
public class SqlCaptureTest(SqlCaptureTest.Fixture fixture) : IClassFixture<SqlCaptureTest.Fixture>
{
    /// <summary>
    ...
    /// <summary>
    ///     Once <c>After</c> has closed the test, a statement is not the test's any more: a test
    ///     class's <c>Dispose</c> runs after <c>After</c>, and its statements belong to no entry.
    /// </summary>
    [ConditionalFact]
