...
/// <summary>
///     <see cref="NorthwindStringIncludeQueryTestBase{TFixture}" /> over the InfoCarrier client with an InMemory backend.
/// </summary>
/// <remarks>
///     <para>
///         Each override mirrors EF Core's own <c>NorthwindStringIncludeQueryInMemoryTest</c>
///         one for one. 
///     </para>
///     <para>
    ...
    : NorthwindStringIncludeQueryTestBase<NorthwindQueryInfoCarrierFixture<NoopModelCustomizer>>(fixture)
{
    /// <inheritdoc />
    [StoreLimit(
        UpstreamRepository.EfCore, "test/EFCore.InMemory.FunctionalTests/Query/NorthwindStringIncludeQueryInMemoryTest.cs", 10, 11,
