...
namespace TestNamespace
{
    ...
    public partial class PrincipalBasePrincipalDerivedDependentBasebyteEntityType
    {
        public static RuntimeEntityType Create(RuntimeModel model, RuntimeEntityType baseEntityType = null)
        {
            ...
            derivedsId.TypeMapping = InfoCarrierTypeMapping.Default.Clone(
            ...
            derivedsAlternateId.TypeMapping = InfoCarrierTypeMapping.Default.Clone(
            ...
            principalsId.TypeMapping = InfoCarrierTypeMapping.Default.Clone(
                comparer: new ValueComparer<long>(
                    bool (long v1, long v2) => v1 == v2,
                    int (long v) => ((object)v).GetHashCode(),
                    long (long v) => v),
            ...
            principalsAlternateId.TypeMapping = InfoCarrierTypeMapping.Default.Clone(
                comparer: new ValueComparer<Guid>(
                    bool (Guid v1, Guid v2) => v1 == v2,
                    int (Guid v) => ((object)v).GetHashCode(),
                    Guid (Guid v) => v),
            ...
            rowid.SetPropertyIndexes(
                ...
                relationshipIndex: -1,
                storeGenerationIndex: -1);
            rowid.TypeMapping = InfoCarrierTypeMapping.Default.Clone(
