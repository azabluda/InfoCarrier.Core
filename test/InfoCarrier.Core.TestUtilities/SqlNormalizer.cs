...
/// <summary>
///     Makes the names in a command text positional, so a capture compares the statement's shape and
///     not the names a client happened to choose (#167, <c>docs/sql-capture.md</c> §4.3).
/// </summary>
/// <remarks>
///     <para>
